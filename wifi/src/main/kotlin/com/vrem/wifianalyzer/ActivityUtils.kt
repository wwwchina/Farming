...
internal fun WifiActivity.setupToolbar(): Toolbar {
...
internal fun WifiActivity.toggleWiFiBand() {
...
internal fun WifiActivity.startWiFiSettings() =
        this.startActivityForResult(makeIntent(Settings.Panel.ACTION_WIFI), 0)

internal fun WifiActivity.startLocationSettings() =
